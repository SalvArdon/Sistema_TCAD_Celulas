-- ================================================================
-- SISTEMA TCAD CELULAS - BASE DE DATOS COMPLETA (VERSIÓN CORREGIDA)
-- ================================================================
-- Iglesia - Control de Celulas, Liderazgo, Servidores y Ofrendas
-- ================================================================

-- Crear base de datos
CREATE DATABASE IF NOT EXISTS tcad_celulas CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE tcad_celulas;
